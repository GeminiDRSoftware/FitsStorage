...
if __name__ == "__main__":
    ...
    # ISG have local smtp servers set up on the fits hosts that relay mail to
    # the gemini smtp servers without needing to authenticate. Otherwise,
    # the gemini smtp will not relay to external addresses.
            ...
            try:
                ...
                if fitscre.search(html):
                    ...
                    try:
                        ...
                        smtp.sendmail(options.fromaddr, fulllist,
                                      msg.as_string())
                        retval = smtp.quit()
