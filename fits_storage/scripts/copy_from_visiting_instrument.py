...
parser.add_option("--from-dir", action="store", dest="fromdir", help="Directory to copy from")
parser.add_option("--to-dir", action="store", dest="todir", help="Directory to copy to")
