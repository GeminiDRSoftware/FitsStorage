...
text = "<h2>Calibration Check: %d missing, %d warnings.</h2> <h2>You can re-generate the calibration check to account for data or calibrations taken after this email was generated by going to this URL: <a href='%s'>%s</a></h2>" % (missing, warnings, url, url)
