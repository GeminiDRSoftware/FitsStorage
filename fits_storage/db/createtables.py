...
def create_tables(session: Session):
    ...
    if fsc.is_server and not fsc.using_sqlite:
        ...
        db._saved_engine.execute("GRANT DELETE ON notification, ingestqueue TO fitsdata;")
