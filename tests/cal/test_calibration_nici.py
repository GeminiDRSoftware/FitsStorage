...
def test_dark(session):
    ...
    try:
        test_dark_file = 'S20130124S0036.fits'
...
def test_flat(session):
    ...
    save_storage_root = fits_storage_config.storage_root
    try:
        test_flat_file = 'S20130714S0138.fits'
        data_file = 'S20130714S0128.fits'
...
def test_lampoff_flat(session):
    ...
    save_storage_root = fits_storage_config.storage_root
    try:
        test_lampoff_flat_file = 'S20130714S0152.fits'
        data_file = 'S20130714S0155.fits'
