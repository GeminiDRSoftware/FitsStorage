...
class TestUser:
    def test_reset_and_validate_password(self, session):
        user = test_user(session)
    ...
    def test_generate_and_validate_reset_token(self, session):
        user = test_user(session)
