...
# This is very broken right now, by the merge of gemini_obs_db aka fits_storage_db
# and gemini_cal_mgr. Once we've sorted this out and the package and module names
# stabalize, we can fix up the tests.

import os
from datetime import datetime

import fits_storage_core
