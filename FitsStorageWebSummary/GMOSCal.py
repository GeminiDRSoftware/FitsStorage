   ...
   try:
     ...
     for observation_class in (['science', 'dayCal']):
       ...
       if(observation_class == 'science'):
         ...
         query = query.filter(or_(Gmos.amp_read_area == ''''EEV 9273-20-04, right':[2049:4096,1:4608]+'EEV 9273-16-03, right':[1:2048,1:4608]+'EEV 9273-20-03, left':[4097:6144,1:4608]''', Gmos.amp_read_area == ''''EEV 8194-19-04, left':[2049:4096,1:4608]+'EEV 2037-06-03, left':[1:2048,1:4608]+'EEV 8261-07-04, right':[4097:6144,1:4608]'''))
     ...
     for row in list:
       ...
       if(roi == ''''EEV 8194-19-04, left':[2049:4096,1:4608]+'EEV 2037-06-03, left':[1:2048,1:4608]+'EEV 8261-07-04, right':[4097:6144,1:4608]"]'''):
         roi = "Full"
       if(roi == ''''EEV 8194-19-04, left':[2049:4096,1792:2815]+'EEV 2037-06-03, left':[1:2048,1792:2815]+'EEV 8261-07-04, right':[4097:6144,1792:2815]'''):
         roi = "Cent"
