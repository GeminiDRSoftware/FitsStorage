...
mod_python.apache. If we're not in local mode, it import the real mod_python 
...
if(not using_apache):
    ...
    from mod_python.apache import OK, HTTP_NOT_FOUND, HTTP_FORBIDDEN, HTTP_NOT_ACCEPTABLE, HTTP_NOT_IMPLEMENTED, HTTP_SERVICE_UNAVAILABLE, HTTP_BAD_REQUEST
