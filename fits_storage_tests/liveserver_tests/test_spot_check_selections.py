...
inst_spotchecks = [
    ('defaults/date=20200101/Raw/F2', 146, 'S20200101S0043.fits'),
    ('defaults/date=20200101/Raw/GMOS-N', 193, 'N20200101S0039.fits'),
    ('defaults/date=20200101/Raw/GMOS-S', 99, 'S20200101S0002.fits'),
    ('defaults/date=20200101/Raw/GMOS', 292, 'S20200101S0002.fits'),
    ('defaults/date=20200101/Raw/GNIRS', 42, 'N20200101S0002.fits'),
    ('defaults/date=20200101/Raw/NIFS', 62, 'N20200101S0007.fits'),
    ('defaults/date=20200127/Raw/NIRI', 532, 'N20200127S0023.fits'),
    ('defaults/date=20200302/Raw/GSAOI', 135, 'S20200303S0025.fits'),
    ('defaults/date=20230214/Raw/GHOST', 26, 'S20230215S0011.fits'),
    ('defaults/date=20250109/Raw/IGRINS-2', 41, 'N20250109S0281.fits'),
    ('defaults/date=20200131/Raw/IGRINS', 99, 'SDCS_20200130_0013.fits'),
